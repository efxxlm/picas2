...
namespace asivamosffie.model.Models
{
    public partial class devAsiVamosFFIEContext : DbContext
    {
        ...
        public virtual DbSet<ComponenteUsoHistorico> ComponenteUsoHistorico { get; set; }
        public virtual DbSet<ComponenteUsoNovedad> ComponenteUsoNovedad { get; set; }
        public virtual DbSet<ComponenteUsoNovedadHistorico> ComponenteUsoNovedadHistorico { get; set; }
        ...
        public virtual DbSet<ContratacionProyectoAportanteHistorico> ContratacionProyectoAportanteHistorico { get; set; }
        ...
        public virtual DbSet<GestionFuenteFinanciacionHistorico> GestionFuenteFinanciacionHistorico { get; set; }
        ...
        public virtual DbSet<ProyectoAportanteHistorico> ProyectoAportanteHistorico { get; set; }
        ...
        public virtual DbSet<VFichaProyectoSeguimientoTecnicoDiario> VFichaProyectoSeguimientoTecnicoDiario { get; set; }
        public virtual DbSet<VFichaProyectoSeguimientoTecnicoSemanal> VFichaProyectoSeguimientoTecnicoSemanal { get; set; }
        ...
        public virtual DbSet<VPagosSolicitudXsinAmortizacion> VPagosSolicitudXsinAmortizacion { get; set; }
        ...
        public virtual DbSet<VSaldoAliberar> VSaldoAliberar { get; set; }
        ...
        public virtual DbSet<VValorFlujoInversionXseguimientoSemanal> VValorFlujoInversionXseguimientoSemanal { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ContratacionProyectoAportanteHistorico>(entity =>
            {
                entity.Property(e => e.FechaCreacion).HasColumnType("datetime");
                ...
                entity.HasOne(d => d.ContratacionProyectoAportante)
                    .WithMany(p => p.ContratacionProyectoAportanteHistorico)
                    .HasForeignKey(d => d.ContratacionProyectoAportanteId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__Contratac__Cofin__6F357288");
            });
            ...
            modelBuilder.Entity<GestionFuenteFinanciacion>(entity =>
            {
                ...
                entity.Property(e => e.ValorLiberado).HasColumnType("numeric(18, 2)");
            ...
            modelBuilder.Entity<GestionFuenteFinanciacionHistorico>(entity =>
            {
                entity.Property(e => e.FechaCreacion).HasColumnType("datetime");
                ...
                entity.HasOne(d => d.GestionFuenteFinanciacion)
                    .WithMany(p => p.GestionFuenteFinanciacionHistorico)
                    .HasForeignKey(d => d.GestionFuenteFinanciacionId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__GestionFu__Historico__575DE8F7");
            });
            ...
            modelBuilder.Entity<ProyectoAportanteHistorico>(entity =>
            {
                entity.Property(e => e.FechaCreacion).HasColumnType("datetime");
                ...
                entity.HasOne(d => d.ProyectoAportante)
                    .WithMany(p => p.ProyectoAportanteHistorico)
                    .HasForeignKey(d => d.ProyectoAportanteId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK__ProyectoA__Historico__679450C0");
            });
            ...
            modelBuilder.Entity<VAmortizadoXsolicitudPagoFaseCriterioConceptoUso>(entity =>
            {
                ...
                entity.ToView("V_AmortizadoXSolicitudPagoFaseCriterioConceptoUso");
            ...
            modelBuilder.Entity<VConceptosXcontratoXfaseXproyecto>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_ConceptosXContratoXFaseXProyecto");
            ...
            modelBuilder.Entity<VContratoProyectoFechaEstimadaFinalizacion>(entity =>
            {
                ...
                entity.Property(e => e.FechaEstimadaFinProyectoRep).HasColumnType("datetime");
            ...
            modelBuilder.Entity<VFichaProyectoPreparacionConstruccion>(entity =>
            {
                ...
                entity.ToView("V_FichaProyecto_PreparacionConstruccion");
            ...
            modelBuilder.Entity<VFichaProyectoSeguimientoTecnicoDiario>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_FichaProyecto_SeguimientoTecnicoDiario");

                entity.Property(e => e.DisponibilidadEquipo)
                    .IsRequired()
                    .HasMaxLength(250);

                entity.Property(e => e.DisponibilidadMaterial)
                    .IsRequired()
                    .HasMaxLength(250);

                entity.Property(e => e.DisponibilidadPersonal)
                    .IsRequired()
                    .HasMaxLength(12)
                    .IsUnicode(false);
                ...
                entity.Property(e => e.Productividad)
                    .IsRequired()
                    .HasMaxLength(250);
            ...
            modelBuilder.Entity<VFichaProyectoSeguimientoTecnicoSemanal>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_FichaProyecto_SeguimientoTecnicoSemanal");

                entity.Property(e => e.AvanceFisico).HasColumnType("decimal(18, 3)");
                ...
                entity.Property(e => e.ProgramacionObra).HasColumnType("decimal(18, 3)");
            });
            ...
            modelBuilder.Entity<VListaProyectos>(entity =>
            {
                ...
                entity.Property(e => e.CodigoEstadoProyectoInterventoria)
                    .HasMaxLength(100)
                    .IsUnicode(false);

                entity.Property(e => e.CodigoEstadoProyectoObra)
                    .HasMaxLength(100)
                    .IsUnicode(false);
            ...
            modelBuilder.Entity<VOdgValoresFacturados>(entity =>
            {
                ...
                entity.ToView("V_Odg_ValoresFacturados");
            ...
            modelBuilder.Entity<VPagosSolicitudXcontratacionXproyectoXusoXamortizacion>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_PagosSolicitudXContratacionXProyectoXUsoXAmortizacion");
                ...
                entity.Property(e => e.SaldoUso).HasColumnType("decimal(25, 1)");
            ...
            modelBuilder.Entity<VPagosSolicitudXsinAmortizacion>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_PagosSolicitudXSinAmortizacion");
            ...
            modelBuilder.Entity<VPlantillaOrdenGiro>(entity =>
            {
                ...
                entity.Property(e => e.DescuentoOtrosNombre).HasMaxLength(4000);
            ...
            modelBuilder.Entity<VSaldoAliberar>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_SaldoALiberar");
            ...
            modelBuilder.Entity<VValorFacturadoContratoXproyectoXuso>(entity =>
            {
                ...
                entity.Property(e => e.SaldoPresupuestal).HasColumnType("decimal(38, 1)");
            ...
            modelBuilder.Entity<VValorFlujoInversionXseguimientoSemanal>(entity =>
            {
                entity.HasNoKey();

                entity.ToView("V_ValorFlujoInversionXSeguimientoSemanal");
                ...
                entity.Property(e => e.ValorEjecutado).HasColumnType("numeric(38, 2)");
            });

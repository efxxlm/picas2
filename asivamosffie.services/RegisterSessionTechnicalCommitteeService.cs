    ...
    public class RegisterSessionTechnicalCommitteeService : IRegisterSessionTechnicalCommitteeService
    {
                ...
                else
                {
                    ...
                    foreach (var SesionComiteTema in pComiteTecnico.SesionComiteTema)
                    {
                        if (SesionComiteTema.SesionTemaId == 0)
                        {
                            ...
                            SesionComiteTema.UsuarioCreacion = pComiteTecnico.UsuarioCreacion;
                            SesionComiteTema.FechaCreacion = DateTime.Now;
                            SesionComiteTema.Eliminado = SesionComiteTema.Eliminado;
                            SesionComiteTema.RegistroCompleto = ValidarRegistroCompletoSesionComiteTema(SesionComiteTema);
                            //Registros
                        ...
                        else
                        {
                            ...
                            sesionComiteTemaOld.FechaModificacion = DateTime.Now;
                            if (SesionComiteTema.Eliminado == true)
        ...
        public async Task<Respuesta> EliminarSesionComiteTema(int pSesionComiteTemaId, string pUsuarioModificacion)
        {
            ...
            try
            {
                ...
                sesionComiteTemaOld.Eliminado = true;
                sesionComiteTemaOld.FechaModificacion = DateTime.Now;
                sesionComiteTemaOld.UsuarioModificacion = pUsuarioModificacion;
        ...
        public async Task<Respuesta> CreateEditTemasCompromiso(SesionComiteTema pSesionComiteTema)
        {
            ...
            try
            {
                ...
                _context.Set<SesionComiteTema>()
                           ...
                           {
                               FechaModificacion = DateTime.Now,
                               UsuarioModificacion = pSesionComiteTema.UsuarioCreacion,
                               EstadoTemaCodigo = pSesionComiteTema.EstadoTemaCodigo,
        ...
        public async Task<string> ReemplazarDatosPlantillaActa(string strContenido, ComiteTecnico pComiteTecnico)
        {
            try
            {
                ...
                List<NovedadContractual> ListNovedadContractual = _context.NovedadContractual.AsNoTracking()
                ...
                List<ControversiaContractual> ListControversiaContractual = new List<ControversiaContractual>();

                foreach (var ControversiaControversiaId in ListControversiaContractualId)
                {
                    ListControversiaContractual.Add(_context.ControversiaContractual.Where(r => r.ControversiaContractualId == ControversiaControversiaId).FirstOrDefault());
                }
                ...
                List<SesionResponsable> ListResponsables = _context.SesionResponsable.AsNoTracking()
                        .Where(r => r.ComiteTecnicoId == pComiteTecnico.ComiteTecnicoId && r.Eliminado != true).ToList();
                ...
                else
                {
                    ...
                    foreach (var SesionComiteSolicitud in pComiteTecnico.SesionComiteSolicitudComiteTecnico)
                    {
                        ...
                        switch (SesionComiteSolicitud.TipoSolicitudCodigo)
                        {
                            ...
                            case ConstanCodigoTipoSolicitud.Novedad_Contractual:
                                NovedadContractual novedad = ListNovedadContractual.Where(c => c.NovedadContractualId == SesionComiteSolicitud.SolicitudId).FirstOrDefault();
                                foreach (Dominio placeholderDominio in placeholders)
                                {
                                    switch (placeholderDominio.Codigo)
                                    {
                            ...
                            case ConstanCodigoTipoSolicitud.ControversiasContractuales:
                                ...
                                foreach (Dominio placeholderDominio in placeholders)
                                {
                                    switch (placeholderDominio.Codigo)
                                    {
                                        case ConstanCodigoVariablesPlaceHolders.NUMERO_SOLICITUD:
                                            RegistrosSolicitudesContractuales = RegistrosSolicitudesContractuales
                                                .Replace(placeholderDominio.Nombre, controversiaContractual?.NumeroSolicitud);
                                            break;

                                        case ConstanCodigoVariablesPlaceHolders.FECHA_SOLICITUD:
                                            string FechaSolicitud = string.Empty;
                                            if (controversiaContractual.FechaSolicitud.HasValue)
                                            {
                                                FechaSolicitud = ((DateTime)controversiaContractual.FechaSolicitud).ToString("dd-MM-yyy");
                                            }
                                            RegistrosSolicitudesContractuales = RegistrosSolicitudesContractuales
                                                .Replace(placeholderDominio.Nombre, FechaSolicitud);
                                            break;
                    ...
                    foreach (Dominio placeholderDominio in placeholders)
                    {
                        switch (placeholderDominio.Codigo)
                        {
                            ...
                            case ConstanCodigoVariablesPlaceHolders.RESPONSABLE_ES_DELEGADO:
                                RegistrosResponsables = RegistrosResponsables
                                    .Replace(placeholderDominio.Nombre, responsable.EsDelegado != true ? "No" : "Si");
                                break;
                        }
                    }
                }
                ...
                foreach (SesionComiteSolicitud SesionComiteSolicitud in pComiteTecnico.SesionComiteSolicitudComiteTecnico.OrderByDescending(r => r.TipoSolicitudCodigo))
                {
                    ...
                    switch (SesionComiteSolicitud.TipoSolicitudCodigo)
                    {
                                ...
                                switch (placeholderDominio.Codigo)
                                {
                                    ...
                                    case ConstanCodigoVariablesPlaceHolders.DECISIONES_SOLICITUD:
                                        ...
                                        if (SesionComiteSolicitud.RequiereVotacion == true)
                                        {
                                            ...
                                            int cantidadNoAprobadas = SesionComiteSolicitud.SesionSolicitudVoto.Where(r => r.Eliminado != true && r.EsAprobado.Value != true && r.ComiteTecnicoFiduciarioId == null && r.NoAplica != true).Count();
                                            int cantidadNoAplica = SesionComiteSolicitud.SesionSolicitudVoto.Where(r => r.Eliminado != true && r.NoAplica != null && r.NoAplica != false && r.ComiteTecnicoFiduciarioId == null).Count();
                            ...
                            foreach (Dominio placeholderDominio in placeholders)
                            {
                                ...
                                switch (placeholderDominio.Codigo)
                                {
                                    ...
                                    case ConstanCodigoVariablesPlaceHolders.JUSTIFICACION_PROCESO:
                                        procesoSeleccion.Justificacion = procesoSeleccion.Justificacion.Replace("style", "");
                                        registrosContratacion = registrosContratacion
                                    ...
                                    case ConstanCodigoVariablesPlaceHolders.DECISIONES_SOLICITUD:
                                        ...
                                        if (SesionComiteSolicitud.RequiereVotacion == true)
                                        {
                                            ...
                                            int cantidadNoAprobadas = SesionComiteSolicitud.SesionSolicitudVoto.Count(r => r.Eliminado != true && r.EsAprobado.Value != true && r.ComiteTecnicoFiduciarioId == null && r.NoAplica != true);
                                            int cantidadNoAplica = SesionComiteSolicitud.SesionSolicitudVoto.Count(r => r.Eliminado != true && r.NoAplica != null && r.NoAplica != null && r.NoAplica != false && r.ComiteTecnicoFiduciarioId == null);
                        ...
                        case ConstanCodigoTipoSolicitud.Novedad_Contractual:
                            ...
                            foreach (var item in novedad.NovedadContractualDescripcion)
                            {
                                if (item.Eliminado == null || item.Eliminado == false)
                                {
                                    ...
                                    string tipoNovedadTemp = ListParametricas.Where(r => r.Codigo == item.TipoNovedadCodigo && r.TipoDominioId == (int)EnumeratorTipoDominio.Tipo_Novedad_Modificacion_Contractual).FirstOrDefault().Nombre;
                            ...
                            foreach (Dominio placeholderDominio in placeholders)
                            {
                                switch (placeholderDominio.Codigo)
                                {
                                    ...
                                    case ConstanCodigoVariablesPlaceHolders.REGISTROS_TABLA_PROYECTO:
                                        ...
                                        if (contratacionNovedad.ContratacionProyecto != null && contratacionNovedad.ContratacionProyecto.Count > 0)
                                            contratacionNovedad.ContratacionProyecto = contratacionNovedad.ContratacionProyecto.Where(r => !(bool)r.Eliminado).ToList();

                                        foreach (var ContratacionProyecto in contratacionNovedad.ContratacionProyecto)
                                        {
                                            RegistrosProyectos += PlantillaRegistrosProyectos;
                                            Localizacion Municipio = localizacions.Where(r => r.LocalizacionId == ContratacionProyecto.Proyecto.LocalizacionIdMunicipio).FirstOrDefault();
                                            Localizacion Departamento = localizacions.Where(r => r.LocalizacionId == Municipio.IdPadre).FirstOrDefault();
                                            ...
                                            List<Dominio> Dominios = ListParametricas.Where(r => r.TipoDominioId == (int)EnumeratorTipoDominio.Tipo_de_Intervencion).ToList();
                                                ...
                                                switch (placeholderDominio2.Codigo)
                                                {
                                                    ...
                                                    case ConstanCodigoVariablesPlaceHolders.TIPO_INTERVENCION:
                                                        RegistrosProyectos = RegistrosProyectos
                                                            .Replace(placeholderDominio2.Nombre,
                                                               ListParametricas
                                                               .Where(r => r.Codigo == proyecto.TipoIntervencionCodigo
                                                               && r.TipoDominioId == (int)EnumeratorTipoDominio.Tipo_de_Intervencion).FirstOrDefault().Nombre);
                                                        break;
                                ...
                                switch (placeholderDominio.Codigo)
                                {
                                    ...
                                    case ConstanCodigoVariablesPlaceHolders.DECISIONES_SOLICITUD:
                                        ...
                                        if (SesionComiteSolicitud.RequiereVotacion == true)
                                        {
                                            int cantidadAprobadas = SesionComiteSolicitud.SesionSolicitudVoto.Where(r => r.Eliminado != true && r.EsAprobado.Value == true && r.ComiteTecnicoFiduciarioId == null).Count();
                                            int cantidadNoAprobadas = SesionComiteSolicitud.SesionSolicitudVoto.Where(r => r.Eliminado != true && r.EsAprobado.Value != true && r.ComiteTecnicoFiduciarioId == null && r.NoAplica != true).Count();
                                            int cantidadNoAplica = SesionComiteSolicitud.SesionSolicitudVoto.Where(r => r.Eliminado != true && r.NoAplica != null && r.NoAplica != false == true && r.ComiteTecnicoFiduciarioId == null).Count();
                                    ...
                                    case ConstanCodigoVariablesPlaceHolders.RESULTADO_VOTACION:
                                            ...
                                            )
                                        {
                                            ...
                                            SesionComiteSolicitud.SesionSolicitudVoto.Where(v => v.Eliminado != true && v.ComiteTecnicoFiduciarioId == null)
                                                                                     .ToList()
                                                                                     .ForEach(ssv =>
                                            {
                                                if (ssv.EsAprobado != true && ssv.NoAplica != true)
                                                    cantidadNoAprobado++;
                                                else if (ssv.EsAprobado == true)
                                                    cantidadAprobado++;
                                                else cantidadNoAplica++;
                                            });
                        ...
                        case ConstanCodigoTipoSolicitud.Actuaciones_Controversias_Contractuales:
                            ...
                            {
                                contratistaAct = ListContratista
                ...
                foreach (var Tema in pComiteTecnico.SesionComiteTema.Where(r => r.EsProposicionesVarios == null).ToList())
                {
                    ...
                    foreach (Dominio placeholderDominio in placeholders)
                    {
                        switch (placeholderDominio.Codigo)
                        {
                            ...
                            case ConstanCodigoVariablesPlaceHolders.OBSERVACIONES_SOLICITUD:
                                RegistrosNuevosTemas = RegistrosNuevosTemas
                                   .Replace(placeholderDominio.Nombre, DeleteColorHtml(Tema.ObservacionesDecision) ?? string.Empty);
                                break;
                ...
                foreach (var Tema in pComiteTecnico.SesionComiteTema.Where(r => r.EsProposicionesVarios != null))
                {
                    ...
                    foreach (Dominio placeholderDominio in placeholders)
                    {
                        switch (placeholderDominio.Codigo)
                        {
                            ...
                            case ConstanCodigoVariablesPlaceHolders.OBSERVACIONES_SOLICITUD:
                                RegistrosProposicionVarios = RegistrosProposicionVarios
                                   .Replace(placeholderDominio.Nombre, Tema.ObservacionesDecision);
                                break;
                ...
                foreach (Dominio placeholderDominio in placeholders)
                {
                    switch (placeholderDominio.Codigo)
                    {
                        ...
                        case ConstanCodigoVariablesPlaceHolders.TITULOS_TEMAS_NUEVOS:
                            ...
                            {
                                strTituloTemasNuevos = ListPlantillas.Where(r => r.Codigo == ((int)ConstanCodigoPlantillas.Titulo_temas_nuevos)
                                .ToString()).FirstOrDefault().Contenido;
                            }
                            strContenido = strContenido
                        ...
                        case ConstanCodigoVariablesPlaceHolders.TITULO_PROPOSICIONES_VARIOS:
                            ...
                            if (pComiteTecnico.SesionComiteTema.Where(r => r.EsProposicionesVarios != null).Count() > 0)
                            {
                                strTituloProposicionVarios = ListPlantillas.Where(r => r.Codigo == ((int)ConstanCodigoPlantillas.Titulo_proposicione_varios)
                                .ToString()).FirstOrDefault().Contenido;
                            }
                            strContenido = strContenido
        ...
        public async Task<string> ReemplazarDatosPlantillaNovedadContractual(
            string pPlantilla,
            NovedadContractual novedadContractual,
            List<Plantilla> ListPlantillas = null,
            List<Dominio> ListaParametricas = null,
            List<Localizacion> ListaLocalizaciones = null,
            List<InstitucionEducativaSede> ListaInstitucionEducativaSedes = null,
            List<Contratacion> ListContratacion = null
            )
        {
            try
            {
                ...
                if (ListContratacion == null)
                {
                    ListContratacion = _context.Contratacion.AsNoTracking()
                                                            .Where(c => c.ContratacionId == novedadContractual.Contrato.ContratacionId)
                                                            .Include(r => r.Contrato)
                                                            .Include(r => r.Contratista)
                                                            .Include(r => r.PlazoContratacion)
                                                            .Include(r => r.ContratacionProyecto).ThenInclude(r => r.Proyecto).ThenInclude(r => r.InfraestructuraIntervenirProyecto)
                ...
                string TipoPlantillaRegistrosAlcance = ((int)ConstanCodigoPlantillas.Registros_Tabla_Alcance).ToString();
                string RegistroAlcance = ListPlantillas.Where(r => r.Codigo == TipoPlantillaRegistrosAlcance).Select(r => r.Contenido).FirstOrDefault();

                string TipoPlantillaEjecucionProyecto = ((int)ConstanCodigoPlantillas.Ejecucion_proyecto).ToString();
                string EjecucionProyecto = ListPlantillas.Where(r => r.Codigo == TipoPlantillaEjecucionProyecto).Select(r => r.Contenido).FirstOrDefault();
                ...
                //historial modificaciones
                string TipoPlantillaHistorialModifcaciones = ((int)ConstanCodigoPlantillas.Historial_de_modificaciones_controversias).ToString();
                string HistorialModificaciones = ListPlantillas.Where(r => r.Codigo == TipoPlantillaHistorialModifcaciones).Select(r => r.Contenido).FirstOrDefault();
                string Historiales = "";
                //tipos de novedad en el historial

                string TipoPlantillaNovedadDetalle = ((int)ConstanCodigoPlantillas.Novedades_detalles).ToString();
                string NovedadDetalle = ListPlantillas.Where(r => r.Codigo == TipoPlantillaNovedadDetalle).Select(r => r.Contenido).FirstOrDefault();
                string NovedadesDetalles = "";
                //adicion
                string TipoPlantillaNovedadAdicion = ((int)ConstanCodigoPlantillas.Tipo_de_novedad_adicion).ToString();
                string NovedadAdicion = ListPlantillas.Where(r => r.Codigo == TipoPlantillaNovedadAdicion).Select(r => r.Contenido).FirstOrDefault();
                string NovedadesAdicion = "";
                //prorroga
                string TipoPlantillaNovedadProrroga = ((int)ConstanCodigoPlantillas.Tipo_de_novedad_prorroga).ToString();
                string NovedadProrroga = ListPlantillas.Where(r => r.Codigo == TipoPlantillaNovedadProrroga).Select(r => r.Contenido).FirstOrDefault();
                string NovedadesProrroga = "";
                //modificacion contractal
                string TipoPlantillaNovedadModificacion = ((int)ConstanCodigoPlantillas.Tipo_de_novedad_modificacion_contractual).ToString();
                string NovedadModificacion = ListPlantillas.Where(r => r.Codigo == TipoPlantillaNovedadModificacion).Select(r => r.Contenido).FirstOrDefault();
                string NovedadesModificacion = "";
                //otras
                string TipoPlantillaNovedadOtras = ((int)ConstanCodigoPlantillas.Tipo_de_novedad_otras).ToString();
                string NovedadOtras = ListPlantillas.Where(r => r.Codigo == TipoPlantillaNovedadOtras).Select(r => r.Contenido).FirstOrDefault();
                string NovedadesOtras = "";

                //APORTANTES

                string TipoPlantillaAportantes = ((int)ConstanCodigoPlantillas.Tipo_de_novedad_adicion_aportante).ToString();
                string Aportante = ListPlantillas.Where(r => r.Codigo == TipoPlantillaAportantes).Select(r => r.Contenido).FirstOrDefault();
                string Aportantes = " ";
                decimal presupuestoAdicion = 0;

                //Detalle solicitud
                string TipoPlantillaDetalleSolicitud = ((int)ConstanCodigoPlantillas.Detalle_solicitud_novedad).ToString();
                string DetalleSolicitud = ListPlantillas.Where(r => r.Codigo == TipoPlantillaDetalleSolicitud).Select(r => r.Contenido).FirstOrDefault();
                string DetallesSolicitudes = "";
                ...
                if (novedadContractual != null)
                {
                    foreach (NovedadContractualAportante novedadContractualAportante in novedadContractual.NovedadContractualAportante)
                    {
                        ...
                        {
                            componenteAportanteNovedad.NombreTipoComponente = ListaParametricas.Where(r => r.TipoDominioId == (int)EnumeratorTipoDominio.Componentes && r.Codigo == componenteAportanteNovedad.TipoComponenteCodigo)
                                                                                    ?.FirstOrDefault()
                                                                                    ?.Nombre;

                            componenteAportanteNovedad.Nombrefase = ListaParametricas.Where(r => r.TipoDominioId == (int)EnumeratorTipoDominio.Fases && r.Codigo == componenteAportanteNovedad.FaseCodigo)
                                                                                    ?.FirstOrDefault()
                                                                                    ?.Nombre;
                            ...
                            foreach (ComponenteFuenteNovedad componenteFuenteNovedad in componenteAportanteNovedad.ComponenteFuenteNovedad)
                            {
                                ...
                                foreach (ComponenteUsoNovedad componenteUsoNovedad in componenteFuenteNovedad.ComponenteUsoNovedad)
                                {
                                    ...
                                    componenteUsoNovedad.NombreUso = ListaParametricas.Where(r => r.Codigo == componenteUsoNovedad.TipoUsoCodigo && r.TipoDominioId == (int)EnumeratorTipoDominio.Usos)
                                                                                     ?.FirstOrDefault()
                                                                                     ?.Nombre;
                                }
                        ...
                        if (codigotipoNovedadTemp == ConstanTiposNovedades.Adición)
                        {
                            ...
                            foreach (var aportante in novedadContractual.NovedadContractualAportante)
                            {
                                ...
                                foreach (var cpa in aportante.ComponenteAportanteNovedad)
                                {
                                    ...
                                    List<ComponenteFuenteNovedad> componenteFuenteNovedades = cpa.ComponenteFuenteNovedad
                ...
                if (contratacion != null)
                {
                    contratista = novedadContractual.Contrato.Contratacion.Contratista;
                    disponibilidadPresupuestal = novedadContractual.Contrato.Contratacion.DisponibilidadPresupuestal.FirstOrDefault();
                }
                ...
                foreach (var contratacionProyecto in contratacion.ContratacionProyecto)
                {
                    foreach (var ContratacionProyectoAportante in contratacionProyecto.ContratacionProyectoAportante)
                    {
                        ...
                        ContratacionProyectoAportante contratacionProyectoAportante = ContratacionProyectoAportante;
                                    ...
                                    */
                                    ...
                                    switch (contratacionProyectoAportante.CofinanciacionAportante.TipoAportanteId)
                                    {
                                        ...
                                        case ConstanTipoAportante.ET:
                                            ...
                                            if (contratacionProyectoAportante.CofinanciacionAportante.DepartamentoId != null && contratacionProyectoAportante.CofinanciacionAportante.MunicipioId == null)
                                            {

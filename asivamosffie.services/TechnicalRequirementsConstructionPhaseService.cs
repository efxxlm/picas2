...
namespace asivamosffie.services
{
    public class TechnicalRequirementsConstructionPhaseService : ITechnicalRequirementsConstructionPhaseService
    {
        ...
        private Proyecto CalcularFechasContrato(int pProyectoId, DateTime? pFechaInicioObra, int pContratoId)
        {
        ...
        public async Task<byte[]> GetPDFDRP(int pContratoId, string usuarioModificacion)
        {
            ...
            if (contrato?.Contratacion?.DisponibilidadPresupuestal != null)
                return await _budgetAvailabilityService.GetPDFDRP(contrato.Contratacion.DisponibilidadPresupuestal.FirstOrDefault().DisponibilidadPresupuestalId, usuarioModificacion, false);
            else
            {

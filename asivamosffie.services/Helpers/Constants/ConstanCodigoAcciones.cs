namespace asivamosffie.services.Helpers.Constant
{
    public class ConstantCodigoAcciones
    {
        ...
        public const string Validar_Archivo_Excel = "6";
        ...
        public const string Aprobar_Acta = "73";

    ...
    public class BudgetAvailabilityController : ControllerBase
    {
        ...
        public async Task<IActionResult> SetCancelarDDP(DisponibilidadPresupuestalObservacion pDisponibilidadPresObservacion)
        {
            ...
            try
            {
                ...
                Task<Respuesta> result = _budgetAvailabilityService.SetCancelRegistroPresupuestal(pDisponibilidadPresObservacion, false,
        ...
        [Route("GenerateDDP")]
        [HttpGet]
        public async Task<IActionResult> GenerateDDP([FromQuery] int id, bool esNovedad, int pRegistroPresupuestalId, bool esValidar, bool esLiberacion)
        {
            try
            {
                HttpContext.Connection.RemoteIpAddress.ToString();
                string UsuarioModificacion = HttpContext.User.FindFirst("User").Value;
                return File(await _budgetAvailabilityService.GetPDFDDP(id, UsuarioModificacion, esNovedad, pRegistroPresupuestalId, esValidar, esLiberacion), "application/pdf");
            }
            catch (Exception ex)
            {
                return BadRequest(ex.ToString());
        ...
        [HttpPost]
        public async Task<IActionResult> SetValidarValidacionDDP(int id, bool esNovedad, int RegistroPresupuestalId)
        {
            ...
            try
            {
                HttpContext.Connection.RemoteIpAddress.ToString();
                string UsuarioModificacion = HttpContext.User.FindFirst("User").Value;
                Task<Respuesta> result = _budgetAvailabilityService.SetValidarValidacionDDP(id, UsuarioModificacion, esNovedad, RegistroPresupuestalId,
                    _settings.Value.DominioFront, _settings.Value.MailServer, _settings.Value.MailPort, _settings.Value.EnableSSL, _settings.Value.Password, _settings.Value.Sender);
                object respuesta = await result;
                return Ok(respuesta);
            }
        ...
        public async Task<IActionResult> SetCancelarDDR(DisponibilidadPresupuestalObservacion pDisponibilidadPresObservacion)
        {
            ...
            try
            {
                ...
                string UsuarioModificacion = HttpContext.User.FindFirst("User").Value;
                pDisponibilidadPresObservacion.UsuarioCreacion = UsuarioModificacion;
                Task<Respuesta> result = _budgetAvailabilityService.SetCancelRegistroPresupuestal(pDisponibilidadPresObservacion,true,
                    _settings.Value.DominioFront, _settings.Value.MailServer, _settings.Value.MailPort, _settings.Value.EnableSSL, _settings.Value.Password, _settings.Value.Sender);
                object respuesta = await result;
                return Ok(respuesta);
            }

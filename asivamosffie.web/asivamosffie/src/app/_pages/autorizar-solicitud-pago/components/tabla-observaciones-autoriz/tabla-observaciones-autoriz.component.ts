...
@Component({
  selector: 'app-tabla-observaciones-autoriz',
  templateUrl: './tabla-observaciones-autoriz.component.html',
  styleUrls: ['./tabla-observaciones-autoriz.component.scss']
})
export class TablaObservacionesAutorizComponent implements OnInit {

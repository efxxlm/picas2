...
@Component({
  selector: 'app-obs-valid-listchqeo-autoriz',
  templateUrl: './obs-valid-listchqeo-autoriz.component.html',
  styleUrls: ['./obs-valid-listchqeo-autoriz.component.scss']
})
export class ObsValidListchqeoAutorizComponent implements OnInit {

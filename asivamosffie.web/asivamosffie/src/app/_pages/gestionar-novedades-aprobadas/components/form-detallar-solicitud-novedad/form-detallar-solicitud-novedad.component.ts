  ...
  ngOnInit(): void {
    ...
    this.route.params.subscribe((params: Params) => {
      ...
      forkJoin([
        ...
        this.contractualNoveltyService.GetAportanteByNovedadContractualId(this.novedad.novedadContractualId),
        //this.contractualNoveltyService.GetAportanteByContratacion(this.novedad.contrato.contratoId),

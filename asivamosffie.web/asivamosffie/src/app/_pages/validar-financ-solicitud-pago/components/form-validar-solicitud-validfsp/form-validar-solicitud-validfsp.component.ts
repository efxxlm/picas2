...
@Component({
  selector: 'app-form-validar-solicitud-validfsp',
  templateUrl: './form-validar-solicitud-validfsp.component.html',
  styleUrls: ['./form-validar-solicitud-validfsp.component.scss']
})
export class FormValidarSolicitudValidfspComponent implements OnInit {

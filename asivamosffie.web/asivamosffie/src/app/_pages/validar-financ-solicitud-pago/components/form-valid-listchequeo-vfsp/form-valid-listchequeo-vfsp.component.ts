        ...
        if ( this.contrato === undefined && this.solicitudPago !== undefined ) {
            ...
            for ( const solicitudPagoListaChequeo of this.solicitudPago.solicitudPagoListaChequeo ) {
                ...
                for ( const solicitudPagoListaChequeoRespuesta of solicitudPagoListaChequeo.solicitudPagoListaChequeoRespuesta ) {
                    ...
                    if ( solicitudPagoListaChequeoRespuesta.validacionRespuestaCodigo === undefined ) {
                        sinDiligenciar++;
                    }
                        ...
                        this.fb.group(
                            {
                                ...
                                observacion: [ solicitudPagoListaChequeoRespuesta.validacionObservacion !== undefined ? solicitudPagoListaChequeoRespuesta.validacionObservacion : null, Validators.required ],
                                ...
                                validacionRespuestaCodigo: [ solicitudPagoListaChequeoRespuesta.validacionRespuestaCodigo !== undefined ? solicitudPagoListaChequeoRespuesta.validacionRespuestaCodigo : null, Validators.required ],
                ...
                solicitudPagoListaChequeoRespuesta.push(
                    {
                        ...
                        tieneSubsanacion: controlRespuesta.get( 'validacionRespuestaCodigo' ).value === this.noCumpleCodigo ? controlRespuesta.get( 'tieneSubsanacion' ).value : null,
                        verificacionRespuestaCodigo: controlRespuesta.get( 'respuestaRevisionTecnicaCodigo' ).value,
                        validacionRespuestaCodigo: controlRespuesta.get( 'validacionRespuestaCodigo' ).value,
                        validacionObservacion: controlRespuesta.get( 'validacionRespuestaCodigo' ).value === this.noCumpleCodigo ? controlRespuesta.get( 'observacion' ).value : null
                    }
                );
            } )

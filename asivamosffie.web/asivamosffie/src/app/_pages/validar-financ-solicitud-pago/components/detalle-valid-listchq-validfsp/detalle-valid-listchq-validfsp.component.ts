...
@Component({
  selector: 'app-detalle-valid-listchq-validfsp',
  templateUrl: './detalle-valid-listchq-validfsp.component.html',
  styleUrls: ['./detalle-valid-listchq-validfsp.component.scss']
})
export class DetalleValidListchqValidfspComponent implements OnInit {
  ...
  dataTable: any[] = [
    {
      ...
      validacionFinanciera: 'Sí cumple'
    },
    {
      item: '2',

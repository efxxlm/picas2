...
@Component({
  selector: 'app-tabla-facturado-og-gtlc',
  templateUrl: './tabla-facturado-og-gtlc.component.html',
  styleUrls: ['./tabla-facturado-og-gtlc.component.scss']
})
export class TablaFacturadoOgGtlcComponent implements OnInit {

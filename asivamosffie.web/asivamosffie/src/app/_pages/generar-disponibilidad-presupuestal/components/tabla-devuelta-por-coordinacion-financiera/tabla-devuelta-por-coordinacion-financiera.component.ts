...
@Component({
  selector: 'app-tabla-devuelta-por-coordinacion-financiera',
  templateUrl: './tabla-devuelta-por-coordinacion-financiera.component.html',
  styleUrls: ['./tabla-devuelta-por-coordinacion-financiera.component.scss']
})
export class TablaDevueltaPorCoordinacionFinancieraComponent implements OnInit {

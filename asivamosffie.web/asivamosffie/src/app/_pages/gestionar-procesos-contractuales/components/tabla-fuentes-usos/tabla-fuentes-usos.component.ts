...
@Component({
  selector: 'app-tabla-fuentes-usos',
  templateUrl: './tabla-fuentes-usos.component.html',
  styleUrls: ['./tabla-fuentes-usos.component.scss']
})
export class TablaFuentesUsosComponent implements OnInit {

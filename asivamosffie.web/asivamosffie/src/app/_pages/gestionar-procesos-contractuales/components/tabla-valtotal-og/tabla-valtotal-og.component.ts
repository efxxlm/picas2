...
@Component({
  selector: 'app-tabla-valtotal-og',
  templateUrl: './tabla-valtotal-og.component.html',
  styleUrls: ['./tabla-valtotal-og.component.scss']
})
export class TablaValtotalOgComponent implements OnInit {

...
@Component({
  selector: 'app-tabla-devuelta-por-coordinacion',
  templateUrl: './tabla-devuelta-por-coordinacion.component.html',
  styleUrls: ['./tabla-devuelta-por-coordinacion.component.scss']
})
export class TablaDevueltaPorCoordinacionComponent implements OnInit {
  ...
  verDetalle(id: number) {
    console.log(id);
    this.router.navigate(['validarDisponibilidadPresupuesto/devueltaProCoordinacionFinanciera', id]);
  }

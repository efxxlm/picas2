...
export class VerDetalleRegistroComponent implements OnInit {
  ...
  volver(){
    //this.router.navigate(['/registroSeguimientoDiario/verBitacora', this.proyecto.contratacionProyectoId]);
    this.router.navigate( [ '/verificarSeguimientoDiario/verBitacora', this.proyecto.contratacionProyectoId ], { state: { proyecto: this.proyecto } } )
  }

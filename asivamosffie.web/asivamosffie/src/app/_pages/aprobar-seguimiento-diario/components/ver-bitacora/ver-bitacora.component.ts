...
export class VerBitacoraComponent implements AfterViewInit {
  ...
  verDetalle( seguimiento ){
    this.router.navigate( [ `/aprobarSeguimientoDiario/verBitacora/${this.proyecto.contratacionProyectoId}/verDetalle`, seguimiento.seguimientoDiarioId ], { state: { proyecto: this.proyecto } } )
  }

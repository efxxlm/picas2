...
@Component({
  selector: 'app-dialog-rechazar-solicitud',
  templateUrl: './dialog-rechazar-solicitud.component.html',
  styleUrls: ['./dialog-rechazar-solicitud.component.scss']
})
export class DialogRechazarSolicitudComponent implements OnInit {

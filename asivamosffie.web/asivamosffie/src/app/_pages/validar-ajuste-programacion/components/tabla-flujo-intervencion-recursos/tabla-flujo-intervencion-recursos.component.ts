...
@Component({
  selector: 'app-tabla-flujo-intervencion-recursos',
  templateUrl: './tabla-flujo-intervencion-recursos.component.html',
  styleUrls: ['./tabla-flujo-intervencion-recursos.component.scss']
})
export class TablaFlujoIntervencionRecursosComponent implements AfterViewInit {

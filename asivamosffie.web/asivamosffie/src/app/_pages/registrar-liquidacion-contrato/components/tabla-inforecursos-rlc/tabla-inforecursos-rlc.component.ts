...
@Component({
  selector: 'app-tabla-inforecursos-rlc',
  templateUrl: './tabla-inforecursos-rlc.component.html',
  styleUrls: ['./tabla-inforecursos-rlc.component.scss']
})
export class TablaInforecursosRlcComponent implements OnInit {

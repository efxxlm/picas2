...
@Component({
  selector: 'app-tabla-ejfinanciera-rlc',
  templateUrl: './tabla-ejfinanciera-rlc.component.html',
  styleUrls: ['./tabla-ejfinanciera-rlc.component.scss']
})
export class TablaEjfinancieraRlcComponent implements OnInit {

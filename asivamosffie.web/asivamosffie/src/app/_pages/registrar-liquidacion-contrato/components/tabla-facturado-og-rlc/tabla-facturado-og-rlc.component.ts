...
@Component({
  selector: 'app-tabla-facturado-og-rlc',
  templateUrl: './tabla-facturado-og-rlc.component.html',
  styleUrls: ['./tabla-facturado-og-rlc.component.scss']
})
export class TablaFacturadoOgRlcComponent implements OnInit {

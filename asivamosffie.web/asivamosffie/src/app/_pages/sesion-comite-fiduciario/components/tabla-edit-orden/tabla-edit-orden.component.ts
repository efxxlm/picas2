...
@Component({
  selector: 'app-tabla-edit-orden',
  templateUrl: './tabla-edit-orden.component.html',
  styleUrls: ['./tabla-edit-orden.component.scss']
})
export class TablaEditOrdenComponent implements OnInit {

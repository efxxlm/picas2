...
@Component({
  selector: 'app-form-edit-aprobar-solicitud',
  templateUrl: './form-edit-aprobar-solicitud.component.html',
  styleUrls: ['./form-edit-aprobar-solicitud.component.scss']
})
export class FormEditAprobarSolicitudComponent implements OnInit {
  idGestion: any;
  solicitud: string;

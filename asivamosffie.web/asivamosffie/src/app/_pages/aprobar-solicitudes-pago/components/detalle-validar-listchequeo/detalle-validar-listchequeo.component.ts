...
@Component({
  selector: 'app-detalle-validar-listchequeo',
  templateUrl: './detalle-validar-listchequeo.component.html',
  styleUrls: ['./detalle-validar-listchequeo.component.scss']
})
export class DetalleValidarListchequeoComponent implements OnInit {

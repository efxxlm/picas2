...
export class ActualizacionPolizaComponent implements OnInit {
  ...
  async getContratoPoliza() {
    ...
    this.registerContractualLiquidationRequestService.getContratoPoliza( this.contratoPolizaId , this.listaMenu.registrarSolicitudLiquidacionContratacion, this.contratacionProyectoId)
        .subscribe(
            response => {
